# Contributing to SharingHub Docs
...
Issue tracker: <https://github.com/csgroup-oss/sharinghub-docs/issues>
...
2. **Clone the Fork**: Clone your fork to your local machine.
   ...
   ```shell
   git clone https://github.com/csgroup-oss/sharinghub-docs.git
   cd sharinghub-docs
   python3 -mvenv .venv
